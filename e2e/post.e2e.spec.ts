...
test('/GET should return error if id does not exist', async() => {
  ...
  const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjA1ODVmZmJmLWUwZGQtNDk4Zi1hNDE4LWI3OGQ2ZGMwODY0MyIsImlhdCI6MTcwODUyNTcwMSwiZXhwIjoxNzA4NjEyMTAxfQ.6GfYz_sB7vLOtNIyuizHTPiTdrg-bkEMwnLAHfUS1-k';
...
test('/GET should return post if everything is ok', async() => {
  const access_token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjA1ODVmZmJmLWUwZGQtNDk4Zi1hNDE4LWI3OGQ2ZGMwODY0MyIsImlhdCI6MTcwODUyNTcwMSwiZXhwIjoxNzA4NjEyMTAxfQ.6GfYz_sB7vLOtNIyuizHTPiTdrg-bkEMwnLAHfUS1-k';
